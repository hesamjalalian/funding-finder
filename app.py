...
#         Racialized group / other: {racialized_info if racialized_info else 'N/A'}.
...
#         Primary business need: {', '.join(primary_need) if primary_need else 'N/A'} {other_primary_need}.
#         Type of business focus: {primary_focus}.
#         Funding purpose: {funding_purpose}.
#         Primary community served: {', '.join(primary_community) if primary_community else 'N/A'}.
#         Website: {website if website else 'N/A'}.
...
# Racialized Group: {racialized_info if racialized_info else 'N/A'}
# Business Registration: {', '.join(business_status) if business_status else 'N/A'}
...
# Funding Purpose: {funding_purpose}
# Primary Community: {', '.join(primary_community) if primary_community else 'N/A'}
# Website: {website if website else 'N/A'}
# """
...
#                 if text_object.getY() < 50:  # add new page when space runs out
#                     pdf.drawText(text_object)
#                     pdf.showPage()
#                     text_object = pdf.beginText(40, 750)
